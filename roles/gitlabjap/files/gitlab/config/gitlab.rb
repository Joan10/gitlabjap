...
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS' # remember to close this block with 'EOS' below
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     label: 'LDAP'
     host: 'alqueria.qui.guifi.net'
     port: 389
     uid: 'uid'
     method: 'plain' # "tls" or "ssl" or "plain"
     bind_dn: 'cn=logger,ou=users,dc=authsd,dc=guifisoller,dc=cat'
     password: 'authsd'
     active_directory: true
     allow_username_or_email_login: false
     block_auto_created_users: false
     base: 'ou=users,dc=authsd,dc=guifisoller,dc=cat'
     user_filter: ''
     attributes:
       ...
       last_name:  'sn'
     ## EE only
     group_base: 'cn=gitlab,ou=groups,dc=authsd,dc=guifisoller,dc=cat'
     admin_group: ''
     sync_ssh_keys: false
   EOS
#
...
# Logrotate #
#############
## see: https://docs.gitlab.com/omnibus/settings/logs.html#logrotate
